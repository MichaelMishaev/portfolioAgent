...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 md:py-32 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950/20 dark:via-purple-950/20 dark:to-pink-950/20">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex justify-center gap-6">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 rounded-full bg-card border flex items-center justify-center hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
              >
