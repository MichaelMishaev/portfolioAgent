...
export function CraftJSTemplateBuilder({ template }: { template: TemplateConfig }) {
  ...
  const infoText = {
    en: {
      ...
      step2: "2. Submit via Telegram or WhatsApp",
      step2desc: "Click Telegram or WhatsApp button to send us your configuration",
    ...
    ru: {
      ...
      step2: "2. Отправьте через Telegram или WhatsApp",
      step2desc: "Нажмите кнопку Telegram или WhatsApp чтобы отправить нам конфигурацию",
