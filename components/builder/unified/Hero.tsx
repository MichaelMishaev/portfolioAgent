  ...
  if (variant === "centered") {
    return (
      <div
        ...
        className={`relative text-center min-h-[250px] sm:min-h-[350px] md:min-h-[500px] lg:min-h-screen flex items-center justify-center border-2 ${selected ? 'border-blue-500' : 'border-transparent'}`}
        style={{
          ...backgroundStyle,
          padding: `${padding}px`,
        }}
