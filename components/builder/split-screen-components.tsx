...
export const SplitScreenHero = ({
  ...
  return (
    <section
      ...
      className={`min-h-[250px] sm:min-h-[350px] md:min-h-[500px] lg:h-screen flex items-center pt-16 ${selected ? "ring-2 ring-blue-500" : ""}`}
    >
...
export const SplitScreenContact = ({
  ...
  return (
    <section
      ref={(ref) => ref && connect(drag(ref))}
      className={`min-h-[250px] sm:min-h-[350px] md:min-h-[500px] lg:min-h-screen flex items-center border-t ${selected ? "ring-2 ring-blue-500" : ""}`}
    >
      <div className="container mx-auto px-3 sm:px-3">
