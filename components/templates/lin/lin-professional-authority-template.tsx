  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <ScrollReveal delay={0.2}>
              <p className="text-2xl md:text-3xl text-[#D4AF37] font-light mb-8">
                {firmData.tagline}
              </p>
            </ScrollReveal>
      ...
      <section id="services" className="container mx-auto px-4 py-20">
        <ScrollReveal>
          <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl font-bold text-center mb-4 text-[#1A1A1A]">
            Our Services
          </h2>
        </ScrollReveal>
            ...
            {firmData.team.map((member, index) => (
              <ScrollReveal key={index} delay={index * 0.1}>
                <Card className="text-center p-8 border-0 shadow-md hover:shadow-xl transition-all">
                  <CardContent className="p-0">
                    <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#1A1A2E] to-[#D4AF37] flex items-center justify-center text-white text-4xl font-bold">
