  ...
  return (
    <div className="min-h-screen overflow-x-hidden max-w-full">
            ...
            {data.stats.map((stat: any, index: number) => (
              <ScrollReveal key={index} delay={index * 0.1}>
                <div className="text-center">
                  <div className="text-6xl font-black text-blue-600 mb-2">{stat.value}</div>
      ...
      <section id="work" className="py-20">
        <div className="container mx-auto max-w-7xl px-6">
          <ScrollReveal>
            <h2 className="text-5xl font-black mb-20 text-center">{data.portfolio.title}</h2>
          </ScrollReveal>
              ...
              <div className={`grid lg:grid-cols-2 gap-12 items-center mb-32 ${
                ...
                <div className={`${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  />
                  <h3 className="text-4xl lg:text-5xl font-bold mb-6 hover:text-blue-600 transition-colors duration-300">{project.title}</h3>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="container mx-auto max-w-7xl px-6">
          <ScrollReveal>
            <h2 className="text-5xl font-black text-center mb-16">{data.services.title}</h2>
          </ScrollReveal>
          ...
          <div className="container mx-auto max-w-7xl px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-5xl font-black mb-4">{data.process.title}</h2>
              ...
              {data.process.steps.map((step: any, index: number) => (
                <ScrollReveal key={index} delay={index * 0.1}>
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <div className="text-6xl font-black text-blue-600/20 mb-4 group-hover:text-blue-600/40 transition-colors">{step.number}</div>
      ...
      {data.team && (
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto max-w-7xl px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-5xl font-black mb-4">{data.team.title}</h2>
      ...
      {data.blog && (
        <section className="py-20 bg-white">
          <div className="container mx-auto max-w-7xl px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-5xl font-black mb-4">{data.blog.title}</h2>
      ...
      {data.awards && (
        <section className="py-20 bg-gray-900 text-white">
          <div className="container mx-auto max-w-7xl px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-5xl font-black mb-4">{data.awards.title}</h2>
      ...
      {data.faq && (
        <section className="py-20 bg-white">
          <div className="container mx-auto max-w-4xl px-6">
            <ScrollReveal>
              <h2 className="text-5xl font-black text-center mb-16">{data.faq.title}</h2>
            </ScrollReveal>
      ...
      {data.newsletter && (
        <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
          <div className="container mx-auto max-w-3xl px-6">
            <ScrollReveal>
              <div className="text-center">
                <h2 className="text-5xl font-black mb-4">{data.newsletter.title}</h2>
      ...
      <footer id="contact" className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-12">
            <h3 className="text-4xl font-black mb-4">{tt.common.getInTouch}</h3>
          ...
          <section className="py-20 border-t border-gray-800">
            <h3 className="text-5xl md:text-7xl font-black mb-12 text-center">OUR SKILLS</h3>
          ...
          <section className="py-20 border-t border-gray-800 bg-gradient-to-br from-purple-900 to-black">
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-5xl md:text-7xl font-black mb-8">ABOUT US</h3>
          ...
          <section className="py-20 border-t border-gray-800">
            <h3 className="text-5xl md:text-7xl font-black mb-12 text-center">PRICING</h3>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className={`bg-gradient-to-br ${pkg.color} p-8 rounded-2xl ${pkg.popular ? 'ring-4 ring-yellow-400 scale-105' : ''}`}>
                  ...
                  <div className="text-6xl font-black text-white mb-8">{pkg.price}</div>
          ...
          <section className="py-20 border-t border-gray-800 bg-gradient-to-br from-red-900 to-black">
            <h3 className="text-5xl md:text-7xl font-black mb-12 text-center">WHAT CLIENTS SAY</h3>
          ...
          <section className="py-20 border-t border-gray-800">
            <h3 className="text-5xl md:text-7xl font-black mb-12 text-center">OUR JOURNEY</h3>
