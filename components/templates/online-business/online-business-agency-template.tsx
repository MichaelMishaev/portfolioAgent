    ...
    <div className="min-h-screen overflow-x-hidden max-w-full bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900">
      ...
      <section className="container mx-auto px-3 md:px-3 max-w-full pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="max-w-full mx-auto text-center">
          <FadeIn>
            <Badge className={`mb-6 bg-blue-100 dark:bg-blue-900/30 border-0 px-3 py-2 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <ScrollReveal delay={0.1}>
              <div>
                ...
                <div className={darkMode ? 'text-gray-400' : 'text-gray-600'}>{data.stats?.satisfaction || "Client Satisfaction"}</div>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div>
                <div className="text-3xl sm:text-5xl font-bold text-blue-600 mb-2 break-words">$50M+</div>
                <div className={darkMode ? 'text-gray-400' : 'text-gray-600'}>{data.stats?.revenue || "Revenue Generated"}</div>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.3}>
              <div>
                <div className="text-3xl sm:text-5xl font-bold text-blue-600 mb-2 break-words">15+</div>
                <div className={darkMode ? 'text-gray-400' : 'text-gray-600'}>{data.stats?.experience || "Years Experience"}</div>
              </div>
            </ScrollReveal>
          </div>
        </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="space-y-4">
                    <input
                      ...
                      className={`w-full px-3 py-3 rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-white/50 bg-white/90 dark:bg-gray-800 ${darkMode ? 'text-white' : 'text-gray-900'}`}
                    />
                    <input
                      type="email"
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-3 rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-white/50 bg-white/90 dark:bg-gray-800 ${darkMode ? 'text-white' : 'text-gray-900'}`}
                    />
                    <select className={`w-full px-3 py-3 rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-white/50 bg-white/90 dark:bg-gray-800 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
