          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {portfolioData.stats.map((stat, index) => (
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
      ...
      <section className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-3 sm:px-3">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold break-words">
              Expertise
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {portfolioData.pricing.map((plan, index) => (
              ...
              >
                ...
                <div className="text-4xl font-bold mb-2 text-purple-400">{plan.price}</div>
