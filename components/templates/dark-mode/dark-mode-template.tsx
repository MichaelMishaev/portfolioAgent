    ...
    <div className="min-h-screen overflow-x-hidden max-w-full bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-3">
          <FadeIn>
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-9xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent break-words">
              {portfolioData.name}
            </h1>
          </FadeIn>
          ...
          {portfolioData.stats.map((stat, index) => (
            <ScrollReveal key={stat.label} delay={index * 0.1}>
              <div className="text-center">
                <div className="text-5xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent mb-3 break-words">
                  {stat.value}
                </div>
            ...
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.1}>
                <div className={`p-8 rounded-2xl border-2 transition-all hover:scale-105 ${
                  ...
                  <div className="text-4xl sm:text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent break-words">
                    {plan.price}
                  </div>
