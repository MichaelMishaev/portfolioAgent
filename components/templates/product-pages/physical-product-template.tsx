...
<a href="#features" className="text-sm hover:text-gray-600 dark:hover:text-gray-400 transition-colors">Features</a>
            ...
            <Button size="sm" className={`bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 ${darkMode ? 'text-black' : 'text-white'}`}>
        ...
        <div className="max-w-full mx-auto">
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className={`sm:text-2xl md:text-3xl text-gray-600 mb-8 ${darkMode ? 'text-gray-400' : 'text-xl'}`}>
                {productData.tagline}
              </p>
              <p className={`text-gray-500 mb-8 ${darkMode ? 'text-gray-500' : 'text-xl'}`}>
              ...
              <Button size="lg" className={`px-12 bg-black dark:bg-white text-white hover:bg-gray-800 dark:hover:bg-gray-200 ${darkMode ? 'text-black' : 'text-lg'}`}>
                Add to Cart
              </Button>
            </div>
          </FadeIn>
            ...
            <ScrollReveal key={feature.title}>
              <div className={`grid grid-cols-1 md:grid-cols-2 gap-16 items-center ${index % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  ...
                  <p className={`text-gray-600 ${darkMode ? 'text-gray-400' : 'text-xl'}`}>
                    {feature.description}
                  </p>
                </div>
      ...
      <section id="specs" className="container mx-auto px-3 sm:px-3 py-32 bg-gray-50 dark:bg-gray-950">
        <ScrollReveal>
          <div className="max-w-full mx-auto">
            <h2 className="text-3xl sm:text-5xl font-bold mb-16 text-center break-words text-gray-900">
                    ...
                    <div className="space-y-4">
                      {category.specs.map((spec) => (
                        <div key={spec.label} className="flex justify-between items-start border-b border-gray-100 dark:border-gray-900 pb-3 last:border-0">
                          <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{spec.label}</span>
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <FiStar key={i} className={`w-6 h-6 fill-black dark:fill-white ${darkMode ? 'text-white' : 'text-black'}`} />
                ))}
              </div>
              <p className={darkMode ? 'text-gray-400' : 'text-gray-600'}>4.9 out of 5 stars from 1,847 reviews</p>
            </div>
                    ...
                    <CardContent className="p-8">
                      <div className="flex gap-1 mb-4">
                        {Array.from({ length: review.rating }).map((_, i) => (
                          <FiStar key={i} className={`w-5 h-5 fill-black dark:fill-white ${darkMode ? 'text-white' : 'text-black'}`} />
                        ))}
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className={`text-gray-600 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>
      ...
      <section className="container mx-auto px-3 sm:px-3 py-32 bg-gray-50 dark:bg-gray-950">
        <ScrollReveal>
          <div className="max-w-full mx-auto text-center">
            ...
            <p className={`text-gray-600 mb-12 ${darkMode ? 'text-gray-400' : 'text-xl'}`}>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-12">
        <div className="container mx-auto px-3 sm:px-3">
          <div className={`text-sm text-gray-600 ${darkMode ? 'text-gray-400' : 'text-center'}`}>
