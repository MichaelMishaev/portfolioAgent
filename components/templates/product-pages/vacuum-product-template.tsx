      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 pt-20 pb-32">
        <div className="container mx-auto px-3 sm:px-3">
          <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn>
              <div>
                <Badge className={`mb-4 bg-blue-100 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 ${darkMode ? 'text-blue-400' : 'text-blue-700'}`}>
                  New Release
                </Badge>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-2xl">
                  <div className="text-center">
                    <div className={`font-bold text-blue-600 ${darkMode ? 'text-blue-400' : 'text-3xl'}`}>{productData.performanceMetrics.suctionPower}</div>
                    <div className="text-xs text-muted-foreground mt-1">Suction</div>
                  </div>
                  <div className="text-center">
                    <div className={`font-bold text-blue-600 ${darkMode ? 'text-blue-400' : 'text-3xl'}`}>{productData.performanceMetrics.runtime}</div>
                    <div className="text-xs text-muted-foreground mt-1">Runtime</div>
                  </div>
                  <div className="text-center">
                    <div className={`font-bold text-blue-600 ${darkMode ? 'text-blue-400' : 'text-3xl'}`}>{productData.performanceMetrics.filtration}</div>
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-16 items-center ${index % 2 === 1 ? "md:grid-flow-dense" : ""}`}>
                  ...
                  <div className={index % 2 === 1 ? "md:col-start-2" : ""}>
                    ...
                    <div className="inline-block p-8 bg-white dark:bg-gray-900 rounded-2xl border-2 border-blue-200 dark:border-blue-900">
                      <div className={`sm:text-5xl font-bold text-blue-600 mb-2 break-words ${darkMode ? 'text-blue-400' : 'text-4xl'}`}>{feature.stat}</div>
                  ...
                  <CardContent>
                    <dl className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <dd className={`font-semibold text-blue-600 ${darkMode ? 'text-blue-400' : 'text-sm'}`}>{mode.suctionPower}</dd>
                      </div>
                    </dl>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
                        <FiCheck className={`w-6 h-6 ${darkMode ? 'text-blue-400' : 'text-blue-600'}`} />
                      </div>
                      <div>
              ...
              <table className="w-full border-collapse bg-white dark:bg-gray-900 rounded-2xl overflow-hidden">
                <thead className="bg-gray-100 dark:bg-gray-800">
                  <tr>
                    ...
                    {productData.comparison.products.map((product) => (
                      <th key={product.name} className={`p-4 font-semibold ${product.current ? "text-blue-600 " : ""} ${darkMode ? 'text-blue-400' : 'text-center'}`}>
                        <div>{product.name}</div>
                        {product.current && (
                          <Badge className={`mt-2 bg-blue-100 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 ${darkMode ? 'text-blue-400' : 'text-blue-700'}`}>
                            Our Pick
                          </Badge>
                        )}
                      </th>
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200 dark:border-gray-800">
                    ...
                    {productData.comparison.products.map((product) => (
                      <td key={product.name} className={`p-4 font-semibold text-blue-600 ${darkMode ? 'text-blue-400' : 'text-center'}`}>{product.suction}</td>
                    ))}
                  </tr>
                  <tr className="border-b border-gray-200 dark:border-gray-800">
