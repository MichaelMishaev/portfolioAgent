        ...
        <div className="max-w-full mx-auto">
          <FadeIn>
            <div className="text-center mb-12">
              <Badge className={`mb-4 bg-blue-100 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
                New
              </Badge>
                  ...
                  <tr className="border-b-2 border-gray-300 dark:border-gray-700">
                    ...
                    {productData.comparison.products.map((product) => (
                      <th key={product.name} className={`p-4 font-semibold ${product.current ? "text-blue-600 " : ""} ${darkMode ? 'text-blue-400' : 'text-center'}`}>
                        {product.name}
                        {product.current && (
                          <Badge className={`ml-2 bg-blue-100 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
                            New
                          </Badge>
                        )}
                      </th>
