    ...
    <div className="min-h-screen grid lg:grid-cols-12">
      ...
      <aside className="lg:col-span-4 lg:fixed lg:h-screen lg:w-1/3 bg-gray-900 text-white p-8 lg:p-12 flex flex-col justify-between overflow-y-auto">
        <div>
          ...
          <h1 className="text-4xl font-bold mb-4">{data.sidebar.name}</h1>
      ...
      <main className="lg:col-span-8 lg:col-start-5 bg-white">
        ...
        <section id="work" className="min-h-screen flex items-center justify-center p-8 lg:p-16">
          <div className="max-w-2xl">
            <ScrollReveal>
              <h2 className="text-5xl lg:text-6xl font-bold mb-8">{data.intro.headline}</h2>
          ...
          >
            ...
            <div className="relative z-10 text-center text-white p-8">
              <ScrollReveal>
                ...
                <h2 className="text-5xl lg:text-6xl font-bold mb-4">{project.title}</h2>
            ...
            <div className="absolute top-8 right-8 text-white/20 text-7xl lg:text-9xl font-black">
        ...
        <section id="about" className="min-h-screen flex items-center p-8 lg:p-16 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              <h2 className="text-4xl font-bold mb-8">{tt.common.about}</h2>
        ...
        <section className="py-20 px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center border-y border-gray-200 py-12">
            {[{ n: "10+", l: "Years" }, { n: "200+", l: "Stories" }, { n: "50M", l: "Readers" }, { n: "15", l: "Awards" }].map((s, i) => (
              <div key={i}>
                <div className="text-5xl font-serif font-bold mb-2">{s.n}</div>
        ...
        <section className="py-20 px-8">
          <h2 className="text-4xl font-serif font-bold mb-12">Career Highlights</h2>
        ...
        <section className="py-20 px-8 bg-gray-50">
          <h2 className="text-4xl font-serif font-bold mb-12">Praise</h2>
        ...
        <section className="py-20 px-8">
          <h2 className="text-4xl font-serif font-bold mb-12">Services & Rates</h2>
        ...
        <section className="py-20 px-8 bg-gray-50">
          <h2 className="text-4xl font-serif font-bold mb-12">FAQ</h2>
        ...
        <section className="py-24 px-8 bg-blue-600 text-white text-center">
          <h2 className="text-5xl font-serif font-bold mb-6">Let's Tell Your Story</h2>
