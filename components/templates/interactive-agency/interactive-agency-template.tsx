  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#0A0A0A] text-white">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {portfolioData.stats.map((stat, index) => (
              ...
              >
                <div className="text-5xl md:text-6xl font-black mb-2 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
      ...
      <section id="work" className="py-32 relative">
        <div className="container mx-auto px-6">
          <ScrollReveal>
            <h2 className="text-5xl md:text-7xl font-black mb-16 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
              Featured Work
            </h2>
          </ScrollReveal>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-4xl md:text-5xl font-black mb-6 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all">
                      {project.title}
                    </h3>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <ScrollReveal>
            <h2 className="text-5xl md:text-7xl font-black mb-16 text-center bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
              Client Love
            </h2>
          </ScrollReveal>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-5xl md:text-7xl font-black mb-6 text-white">Ready to Create Magic?</h2>
      ...
      <footer className="border-t border-purple-500/20 py-12">
        <div className="container mx-auto px-6">
          ...
          <section className="py-20 border-t border-gray-800">
            <h3 className="text-4xl font-bold mb-12 text-center">Our Expertise</h3>
          ...
          <section className="py-20 border-t border-gray-800 bg-gradient-to-br from-gray-900 to-black">
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-4xl font-bold mb-8">Who We Are</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className={`bg-gradient-to-br ${pkg.popular ? 'from-purple-600 to-pink-600' : 'from-gray-800 to-gray-900'} p-8 rounded-xl ${pkg.popular ? 'ring-4 ring-yellow-400 scale-105' : ''}`}>
                  ...
                  <div className="text-5xl font-bold text-white mb-8">{pkg.price}</div>
          ...
          <section className="py-20 border-t border-gray-800">
            <h3 className="text-4xl font-bold mb-12 text-center">Our Story</h3>
