    ...
    <div className="min-h-screen overflow-x-hidden max-w-full bg-white dark:bg-gray-950">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <Link
            href="/"
            className={`text-gray-600 hover:text-teal-600 dark:hover:text-teal-400 transition-colors flex items-center gap-2 ${darkMode ? 'text-gray-400' : 'text-sm'}`}
          >
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-16 sm:py-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <FadeIn className="text-center max-w-4xl mx-auto">
            <Badge
              variant="outline"
              className={`mb-6 px-4 py-2 border-teal-500 dark:border-teal-400 text-teal-600 ${darkMode ? 'text-teal-400' : 'text-sm'}`}
            >
            ...
            <p className={`sm:text-2xl text-gray-600 mb-8 leading-relaxed ${darkMode ? 'text-gray-300' : 'text-xl'}`}>
              {archetypesData.hero.subtitle}
            </p>
            <p className={`sm:text-lg text-gray-500 mb-12 max-w-2xl mx-auto leading-relaxed ${darkMode ? 'text-gray-400' : 'text-base'}`}>
      ...
      <section className="py-16 sm:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <ScrollReveal>
              <h2 className={`sm:text-3xl sm:text-5xl font-bold mb-4 text-gray-900 break-words ${darkMode ? 'text-white' : 'text-3xl'}`}>
                The 7 Creative Archetypes
              </h2>
              <p className={`sm:text-xl text-gray-600 max-w-2xl mx-auto ${darkMode ? 'text-gray-300' : 'text-lg'}`}>
                ...
                <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white dark:bg-gray-800">
                  ...
                  <CardContent className="p-6 sm:p-8">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <span className={`sm:text-4xl font-bold text-gray-200 ${darkMode ? 'text-gray-700' : 'text-3xl'}`}>
                        {archetype.number}
                      </span>
                    ...
                    <h3 className={`font-bold mb-3 text-gray-900 ${darkMode ? 'text-white' : 'text-2xl'}`}>
                      {archetype.title}
                    </h3>
              ...
              <ScrollReveal key={testimonial.id} delay={index * 0.1}>
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all bg-white dark:bg-gray-800 overflow-hidden">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    {/* Quote */}
                    <p className={`mb-6 leading-relaxed italic ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                      "{testimonial.quote}"
                    </p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className={`text-gray-500 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>
                          {testimonial.role}
                        </div>
                      </div>
                    </div>
          ...
          <div className="max-w-5xl mx-auto">
            <ScrollReveal>
              <div className="text-center mb-12">
                ...
                <p className={`sm:text-xl text-gray-600 ${darkMode ? 'text-gray-300' : 'text-lg'}`}>
              ...
              <Card className="border-0 shadow-2xl overflow-hidden bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
                <CardContent className="p-8 sm:p-12">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    {/* Left: Features */}
                    <div>
                      <h3 className={`font-bold mb-6 text-gray-900 ${darkMode ? 'text-white' : 'text-2xl'}`}>
                        What's Included
                      </h3>
      ...
      <footer className="py-12 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className={`flex items-center gap-6 text-gray-600 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>
