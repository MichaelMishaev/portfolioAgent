      ...
      <section className="py-12 sm:py-20 lg:py-32 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-20">
            <FadeIn>
              <h2 className={`font-playfair sm:text-3xl sm:text-5xl md:text-5xl sm:text-5xl md:text-6xl font-black text-slate-900 mb-4 sm:mb-6 leading-tight break-words ${darkMode ? 'text-white' : 'text-3xl'}`}>
                The <span className="text-blue-600">Seven</span> Archetypes
              </h2>
              <div className="w-16 sm:w-24 h-1 bg-blue-600 mx-auto mb-4 sm:mb-6" />
              <p className={`sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto font-light ${darkMode ? 'text-gray-300' : 'text-base'}`}>
                ...
                <Card className="border-4 border-slate-900 dark:border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:shadow-[12px_12px_0px_0px_rgba(59,130,246,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all group overflow-hidden">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div className={`sm:text-7xl font-black text-slate-200 ${darkMode ? 'text-slate-800' : 'text-6xl'}`}>
                        {archetype.number}
                      </div>
                    ...
                    {/* Title */}
                    <h3 className={`font-playfair sm:text-3xl font-black text-slate-900 mb-2 ${darkMode ? 'text-white' : 'text-2xl'}`}>
                      {archetype.title}
                    </h3>
                    ...
                    {/* Description */}
                    <p className={`sm:text-base text-gray-700 mb-6 leading-relaxed ${darkMode ? 'text-gray-300' : 'text-sm'}`}>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-20">
            <FadeIn>
              ...
              <div className="w-16 sm:w-24 h-1 bg-blue-600 mx-auto mb-4 sm:mb-6" />
              <p className={`sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto ${darkMode ? 'text-gray-300' : 'text-base'}`}>
              ...
              <ScrollReveal key={idx} delay={idx * 0.1}>
                <Card className="border-4 border-slate-900 dark:border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:shadow-[12px_12px_0px_0px_rgba(59,130,246,1)] transition-all">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    {/* Quote */}
                    <p className={`sm:text-lg md:text-xl text-gray-700 mb-6 sm:mb-8 leading-relaxed italic font-medium ${darkMode ? 'text-gray-300' : 'text-base'}`}>
                      "{testimonial.quote}"
                    </p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <div className={`font-black sm:text-lg text-slate-900 ${darkMode ? 'text-white' : 'text-base'}`}>
                          {testimonial.name}
                        </div>
                        <div className={`sm:text-base text-gray-600 font-semibold ${darkMode ? 'text-gray-400' : 'text-sm'}`}>
                          {testimonial.role}
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-12 sm:py-20 lg:py-32 bg-slate-900 dark:bg-slate-950 text-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Pricing Card */}
            <FadeIn delay={0.5}>
              <div className={`border-8 border-blue-500 bg-white dark:bg-slate-900 p-8 sm:p-12 shadow-[16px_16px_0px_0px_rgba(59,130,246,1)] max-w-4xl mx-auto ${darkMode ? 'text-white' : 'text-slate-900'}`}>
                <div className="text-center mb-8 sm:mb-12">
                  ...
                  <p className={`sm:text-xl text-gray-600 mb-6 sm:mb-8 ${darkMode ? 'text-gray-300' : 'text-base'}`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
                  ...
                  <div className="border-4 border-slate-900 dark:border-white p-6 sm:p-8 text-center bg-blue-50 dark:bg-slate-800">
                    <div className={`font-bold mb-2 text-gray-600 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>PAY IN FULL</div>
                  ...
                  <div className="border-4 border-slate-900 dark:border-white p-6 sm:p-8 text-center">
                    <div className={`font-bold mb-2 text-gray-600 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>PAYMENT PLAN</div>
                    ...
                    <div className={`sm:text-base font-bold text-gray-600 mb-4 ${darkMode ? 'text-gray-400' : 'text-sm'}`}>12 Monthly Payments</div>
                    <Button
                      variant="outline"
                ...
                <div className="text-center mt-8 sm:mt-12 p-6 sm:p-8 border-4 border-green-500 bg-green-50 dark:bg-slate-800">
                  ...
                  <p className={`sm:text-base text-gray-700 ${darkMode ? 'text-gray-300' : 'text-sm'}`}>
