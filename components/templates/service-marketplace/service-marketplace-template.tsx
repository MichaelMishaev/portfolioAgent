            ...
            {['Web Development', 'Mobile Apps', 'UI/UX Design', 'Backend', 'DevOps', 'Cloud', 'Database', 'API Design', 'Testing', 'Security', 'Analytics', 'AI/ML'].map((skill, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-green-500 hover:shadow-md transition-all text-center">
                  <span className={`font-semibold text-slate-900 ${darkMode ? 'text-white' : 'text-sm'}`}>{skill}</span>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="py-20 px-3">
        <div className="container mx-auto max-w-4xl text-center">
          <FadeIn>
            ...
            <p className={`text-slate-600 mb-8 ${darkMode ? 'text-slate-400' : 'text-lg'}`}>
        ...
        <div className="container mx-auto max-w-4xl">
          <FadeIn>
            ...
            <div className="prose prose-lg max-w-none text-center">
              <p className={`text-slate-600 mb-6 ${darkMode ? 'text-slate-400' : 'text-lg'}`}>
              ...
              <p className={`text-slate-600 ${darkMode ? 'text-slate-400' : 'text-lg'}`}>
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="flex gap-6 items-start">
                  ...
                  <div className="flex-1 bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
                    <h3 className={`font-bold mb-2 text-slate-900 ${darkMode ? 'text-white' : 'text-lg'}`}>{item.title}</h3>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.05}>
                <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
                  <h3 className={`font-bold mb-3 text-slate-900 ${darkMode ? 'text-white' : 'text-lg'}`}>{item.q}</h3>
                  <p className={darkMode ? 'text-slate-400' : 'text-slate-600'}>{item.a}</p>
                </div>
              </FadeIn>
            ))}
          </div>
