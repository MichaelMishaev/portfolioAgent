        ...
        <div className="container mx-auto px-3 sm:px-3 h-full">
          <div className="grid grid-cols-1 md:grid-cols-2 h-full gap-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <FadeIn delay={0.2}>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-4">
                  {portfolioData.title}
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-4 max-w-lg">
