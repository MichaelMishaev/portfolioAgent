                ...
                <div className="mt-4 flex items-start gap-2 text-xs sm:text-sm text-muted-foreground bg-blue-50 dark:bg-blue-950 p-3 rounded-lg">
                  ...
                  <p className="leading-relaxed">
                    {language === 'en'
                      ...
                      : 'Дополнительные услуги (хостинг, домен, установка) будут доступны после покупки.'}
                  </p>
                </div>
              </Card>
              ...
              <Card className="p-4 sm:p-6 lg:sticky lg:top-24">
                ...
                <div className="mt-6 text-center">
                  <div className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>{language === 'en' ? 'Secure SSL Encrypted Payment' : 'Безопасная SSL-шифрованная оплата'}</span>
                  </div>
                </div>
              </Card>
            </div>
